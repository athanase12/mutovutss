...
function Comp1() {
  return (
    <div className="min-h-[80vh] bg-gray-50">
      ...
      <div 
        className="relative h-[500px] w-full bg-cover bg-center mt-0 border-b-20 border-amber-300 
        opacity-200 rounded-b-3xl border-t-4 border-t-green-400"
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center p-8">
          ...
          {/* Main Headline */}
          <h1 className="text-3xl mt-2 sm:mt-4 md:text-7xl font-extrabold text-white mb-4 tracking-tight shadow-text sm:text-sm">
            MUTOVU TSS
          </h1>
